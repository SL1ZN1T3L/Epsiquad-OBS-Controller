...
## [3.3.0] - 2026-01-22
### Добавлено
- Кнопки «Настройки» и «О приложении» теперь доступны без подключения к OBS
- BETA-ленточка в правом верхнем углу для debug-версий приложения
- Автоматическое переименование APK файлов в CI:
  - Release: `OBS-Controller.apk`
  - Debug: `OBS-Controller-Dev.apk`
